  ...
  const mockProducts = [
    {
      ...
      image: '🍅',
      category: 'vegetables',
      seller: { name: 'Green Valley Farm', type: 'farmer', location: 'California' },
      rating: 4.8,
      reviews: 156,
      unit: 'per lb',
      inStock: true,
    },
    {
      ...
      image: '🥬',
      category: 'vegetables',
      seller: { name: 'Organic Harvest Store', type: 'store', location: 'Oregon' },
      rating: 4.9,
      reviews: 89,
      unit: 'per bunch',
      inStock: true,
    },
    {
      ...
      image: '🌾',
      category: 'grains',
      seller: { name: 'Grain Masters Co.', type: 'store', location: 'Colorado' },
      rating: 4.7,
      reviews: 234,
      unit: 'per 2lb bag',
      inStock: true,
    },
    {
      ...
      seller: { name: 'Bee Happy Apiary', type: 'farmer', location: 'Vermont' },
      rating: 5.0,
      reviews: 67,
      unit: 'per 16oz jar',
      inStock: true,
    },
    {
      ...
      image: '🫐',
      category: 'fruits',
      seller: { name: 'Berry Fields Farm', type: 'farmer', location: 'Maine' },
      rating: 4.6,
      reviews: 178,
      unit: 'per pint',
      inStock: true,
    },
    {
      ...
      image: '🥕',
      category: 'vegetables',
      seller: { name: 'Root & Branch Farm', type: 'farmer', location: 'Washington' },
      rating: 4.5,
      reviews: 203,
      unit: 'per lb',
      inStock: true,
